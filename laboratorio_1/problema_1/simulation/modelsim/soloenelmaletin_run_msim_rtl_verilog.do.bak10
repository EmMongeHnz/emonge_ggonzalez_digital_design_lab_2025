...
vlog -sv -work work +incdir+C:/TallerDigital/problema_1 {C:/TallerDigital/problema_1/problema_1.sv}

vlog -sv -work work +incdir+C:/TallerDigital/problema_1 {C:/TallerDigital/problema_1/problema_1_tb.sv}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L rtl_work -L work -voptargs="+acc"  problema_1_tb
