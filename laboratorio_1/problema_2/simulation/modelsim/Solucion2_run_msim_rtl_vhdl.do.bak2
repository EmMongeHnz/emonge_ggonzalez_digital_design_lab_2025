...
vcom -93 -work work {C:/TallerDigital/problema_2/problema_2.vhd}
vcom -93 -work work {C:/TallerDigital/problema_2/restador.vhd}
vcom -93 -work work {C:/TallerDigital/problema_2/hex7seg.vhd}

vcom -93 -work work {C:/TallerDigital/problema_2/problema_2_tb.vhd}

vsim -t 1ps -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L cyclonev_hssi -L rtl_work -L work -voptargs="+acc"  problema_2_tb
