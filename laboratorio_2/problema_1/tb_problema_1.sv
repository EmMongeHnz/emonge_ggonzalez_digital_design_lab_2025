...
module tb_problema_1;
  ...
  // --- OPCODES (deben coincidir con el núcleo) ---
  ...
  // Instanciar el NÚCLEO (alu_core), no el wrapper problema_1
  alu_core #(.N(N4)) DUT4 (
  ...
  initial begin
    ...
    set4(OP_MUL, 4'd6, 4'd6);        show4("MUL");       // overflow esperado en truncado
